...
from .views import DynamicTariffSourceViewSet, TariffViewSet, TariffPeriodViewSet
...
router.register("dynamic-sources", DynamicTariffSourceViewSet, basename="dynamic-tariff-source")
