...
# Seconds before a stalled SMTP connection is abandoned. Without it (Django's
# default is no timeout) one unresponsive mail server can hold a request open
# indefinitely — several auth flows send mail while the person waits.
