...
export const en = {
    ...
    pages: {
        ...
        dynamicSources: {
            ...
            clearWarning: 'This permanently removes billing inputs. Clearing is blocked when an invoice overlaps a linked tariff.',
            ...
            types: {
                electricity: 'Electricity supply', grid: 'Grid usage', integrated: 'Integrated electricity + grid',
                regional_fees: 'Regional fees', feed_in: 'Feed-in remuneration',
            },
            form: {
                label: 'Display label', url: 'Dynamic price URL', adapter: 'Provider format', tariffType: 'Price component',
                tariffName: 'Provider product name', urlHint: 'The server validates and fetches this public HTTPS endpoint.',
                tariffNameRequired: 'Required because Groupe E serves multiple products.',
                tariffNameHint: 'Optional for a standard endpoint that has a default product.',
                identityLocked: 'Clear unprotected fetched prices before changing the URL, provider format, component, or product.',
                probeNotice: 'OpenZEV tests the endpoint before saving it, stores the returned prices, then queues an available-history fetch.',
            },
