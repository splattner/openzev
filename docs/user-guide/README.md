...
- **[Invoice Management](09-invoice-management.md)** — Lifecycle, PDF generation, tracking, participant access links, and yearly reports (annual statements, tax overviews)
